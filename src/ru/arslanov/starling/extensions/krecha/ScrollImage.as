package starling.extensions.krecha 
{
	...
	public class ScrollImage extends DisplayObject
	{
		...
		// vertex ru.financier.data
		private var mVertexData:VertexData;
		private var mVertexBuffer:VertexBuffer3D;

		// ShaderConstand and clipping index ru.financier.data
		private var mExtraBuffer:VertexBuffer3D;
		private var mExtraData:Vector.<Number>;

		// index ru.financier.data
		...
		/**
		 * Creates new vertex- and index-buffers and uploads our vertex- and index-ru.financier.data to those buffers.
		 */
		...
		{	
			...
			//set object and layers ru.financier.data
		...
		/**
		 * Uploads the raw ru.financier.data of all batched quads to the vertex buffer.
		 */
