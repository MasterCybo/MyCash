package ru.arslanov.starling.display
{
	 ...
	 */
	public class AImageStarling extends Image implements IKillableStarling
	{

		static public function getFromBitmap(bitmap:Bitmap,
											 generateMipMaps:Boolean = true,
											 optimizeForRenderToTexture:Boolean = false,
											 scale:Number = 1):AImageStarling
		{
			return new AImageStarling(Texture.fromBitmap(bitmap, generateMipMaps, optimizeForRenderToTexture, scale));
		}
		...
		static public function getFromBitmapData(bitmapData:BitmapData,
												 ...
												 scale:Number = 1):AImageStarling
		{
			return new AImageStarling(Texture.fromBitmapData(bitmapData,
															 generateMipMaps,
		...
		public function AImageStarling(texture:Texture = null)
		{
