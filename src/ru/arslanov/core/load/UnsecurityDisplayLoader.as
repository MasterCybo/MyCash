package ru.arslanov.core.load {
	...
	public class UnsecurityDisplayLoader extends EventDispatcher{
		...
		/**
		 * @return Возвращает последний объект, переданный в URLReqest#ru.financier.data в метод load. Не равен content.loaderInfo.parameters, если загрузка прошла игнорируя безопасность.
		 */
